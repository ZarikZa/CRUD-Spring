...
public class CategoryServiceImpl implements CategoryService {
    ...
    public void deleteMultipleCategories(List<Integer> ids) {
        categoryRepository.deleteMultipleCategories(ids);
    }

    @Override
    public void softDeleteMultipleCategories(List<Integer> ids) {
        categoryRepository.softDeleteMultipleCategories(ids);
    }
    ...
    @Override
    public List<CategoryModel> getCategoriesWithPagination(int page, int size, List<CategoryModel> sourceList) {
        return categoryRepository.findCategoriesWithPagination(page, size, sourceList);
    }

    @Override
    public long getTotalCategoriesCount(List<CategoryModel> sourceList) {
        return categoryRepository.getTotalCount(sourceList);
    }
}